...
contract RightsMarket is ReentrancyGuard,Ownable {
    ...
    struct MarketItem {
        ...
        address payable seller; // Address of user listing the right
        address payable owner; // NFT current owner (Will belong to the minter then can be transfered after purchase)
    ...
    function createMarketItem(
        ...
        require(nftAddress != address(0), "Please set the NFT address first");
        ...
        idToMarketItem[_tokenId] = MarketItem({
            ...
            rightDescription: _rightDescription,
    ...
    function createMarketSale(
        ...
        uint tokenId = idToMarketItem[_tokenId].tokenId;
        require(msg.value == price, "Submit the asking price in order to complete the purchase");    

        idToMarketItem[_tokenId].seller.transfer(msg.value);
