 ...
 * 
 * Liquidity                 5%
 * Redistribution/Commission 2%
 * Marketing/Development     3%
 */

contract CryptoAds is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 200000000 * 10**18; // 200,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CryptoAds";
    string private _symbol = "CADS";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; // Distribution percentage %2
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 30; // Marketing percentage %3
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 50; // Liqudity percentage %5
