...
contract CruxToken is BEP20, BEP20Burnable, Ownable, ReentrancyGuard {
    ...
    function transferFrom(address _to, uint256 amount) public nonReentrant onlyOwner{
        require(!isBlacklisted[_to], "Recipient is blacklisted");
        require(!_paused, "Contract is paused");
        transferFrom(_msgSender(), _to, amount);
    }
